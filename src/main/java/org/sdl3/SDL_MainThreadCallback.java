...
/**
 * {@snippet lang=c :
 * typedef void (*SDL_MainThreadCallback)(void *) __attribute__((cdecl))
 * }
 */
public class SDL_MainThreadCallback {
    ...
    private static final MethodHandle UP$MH = SDL.upcallHandle(SDL_MainThreadCallback.Function.class, "apply", $DESC);
