...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SDL.C_INT.withName("tm_sec"),
        SDL.C_INT.withName("tm_min"),
        SDL.C_INT.withName("tm_hour"),
        SDL.C_INT.withName("tm_mday"),
        SDL.C_INT.withName("tm_mon"),
        SDL.C_INT.withName("tm_year"),
        SDL.C_INT.withName("tm_wday"),
        SDL.C_INT.withName("tm_yday"),
        SDL.C_INT.withName("tm_isdst")
    ).withName("tm");
