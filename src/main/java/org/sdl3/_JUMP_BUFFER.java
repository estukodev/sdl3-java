...
public class _JUMP_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SDL.C_LONG_LONG.withName("Frame"),
        SDL.C_LONG_LONG.withName("Rbx"),
        SDL.C_LONG_LONG.withName("Rsp"),
        SDL.C_LONG_LONG.withName("Rbp"),
        SDL.C_LONG_LONG.withName("Rsi"),
        SDL.C_LONG_LONG.withName("Rdi"),
        SDL.C_LONG_LONG.withName("R12"),
        SDL.C_LONG_LONG.withName("R13"),
        SDL.C_LONG_LONG.withName("R14"),
        SDL.C_LONG_LONG.withName("R15"),
        SDL.C_LONG_LONG.withName("Rip"),
        SDL.C_LONG.withName("MxCsr"),
        SDL.C_SHORT.withName("FpCsr"),
        SDL.C_SHORT.withName("Spare"),
