...
public class _float_const {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.sequenceLayout(4, SDL.C_SHORT).withName("_Word"),
        SDL.C_FLOAT.withName("_Float"),
        SDL.C_DOUBLE.withName("_Double"),
        SDL.C_LONG_DOUBLE.withName("_Long_double")
    ).withName("$anon$268:9");
